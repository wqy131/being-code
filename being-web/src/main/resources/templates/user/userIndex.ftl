...
<html lang="en">
  ...
  <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                	<ul class="nav navbar-nav">
						...
						<li class="scroll"><a href="/index#features">特色</a></li>
                        <li class="scroll"><a href="/index#business-stats">服务</a></li>
                        <!--
                        <li class="scroll"><a href="#about">我们</a></li> 
                        -->
                        <li class="scroll"><a href="/index#feature">分配</a></li>
                        <li class="scroll"><a href="/index#our-team">团队</a></li>
                        <li class="scroll"><a href="/index#contact-us">合作</a></li>  
                        <li class="active"><#if loginUser?exists><#if loginUser.name??><a href="/user/index" id="userName">用户名：${loginUser.name!}</a></#if><#else><a href="/login">登录</a></#if></li>   
	...
	<div class="intr" style="height:auto;padding: 150px 0px;">
        ...
        <p class="peointr">手机号：${loginUser.cellphone!}<#if loginUser.createTime??></p><p class="peointr">实名认证时间：${loginUser.createTime?string["YYYY年MM月dd日 HH:mm:ss"]}</#if>。</p>
  ...
  <script>
	...
	function submitImg(){
		...
		$.ajax({
		    url:'${request.contextPath}/user/saveIDPhoto',
		    type:'POST', //GET

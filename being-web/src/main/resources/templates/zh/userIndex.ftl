...
<html lang="en">
  ...
  <#assign type = "zh">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                	<ul class="nav navbar-nav">
                        <li class="scroll"><a href="/${type}/index#home">首页</a></li> 
						<li class="scroll"><a href="/${type}/index#features">特色</a></li>
                        <li class="scroll"><a href="/${type}/index#business-stats">服务</a></li>
                        <!--
                        <li class="scroll"><a href="#about">我们</a></li> 
                        -->
                        <li class="scroll"><a href="/${type}/index#feature">分配</a></li>
                        <li class="scroll"><a href="/${type}/index#our-team">团队</a></li>
                        <li class="scroll"><a href="/${type}/index#contact-us">合作</a></li>  
                        <li class="active"><#if loginUser?exists><#if loginUser.name??><a href="/${type}/user/index" id="userName">用户名：${loginUser.name!}</a></#if><#else><a href="/${type}/login">登录</a></#if></li>   
	...
	<div class="intr" style="height:auto;padding: 150px 0px;">
        ...
        <p class="peointr"><#if loginUser.name??>用户名：${loginUser.name!}</#if><#if loginUser.email??></p><p class="peointr">邮箱：${loginUser.email!}</#if>。</p>
        <p class="peointr">手机号：${loginUser.cellphone!}<#if loginUser.createTime??></p><p class="peointr">实名认证时间：${loginUser.createTime?string["YYYY-MM-dd HH:mm:ss"]}</#if>。</p>
        ...
        <p class="peointr">
			...
			<#if (!loginUser.fileList?exists || loginUser.fileList?size==0)>
				...
				<p class="peointr">
				<button class="btn btn-large btn-success" onclick="submitImg()">证件照上传</button>
				</p>
			</#if>
		</p>
    ...
    <div class="blog-footer">
      <p>Copyright &copy; 2018.being All rights reserved.<a href="www.being.codes/" target="_blank" title="being.codes">being.codes</a> - 版权所有</p>
    </div>

                            ...
                            <div class="form-bottom">
			                    <form role="form" action="/${type}/submit" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="name" placeholder="아이디" class="form-name form-control" id="name">
			                        </div>
			                        <div class="form-group">
